...
function App() {
  ...
  useEffect(() => {
    ...
    setIsNativeApp(isRunningInCapacitor());
    ...
    <div className={`${themeClasses} overflow-hidden`}>
        ...
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h1
                className={`text-xl font-bold ${headerTextColor} text-center ${
              ...
              {!isMobile && (
                <p className={`text-center text-xs ${subheaderTextColor} mt-1`}>
      ...
      >
        <div className="max-w-md mx-auto">
          ...
          <div
            className={`rounded-2xl p-4 mb-4 border touch-target ${
              isDark
      ...
      <footer className="footer-spacing safe-area-bottom px-4">
